using ReleasedFromTheVoid.Components;
...
namespace ReleasedFromTheVoid
{
    public static class Assets
    {
        ...
        internal static string assemblyDir => Path.GetDirectoryName(RFTVUnityPlugin.pluginInfo.Location);
        ...
        internal static string mainAssetBundleName = "RFTVAssets";
